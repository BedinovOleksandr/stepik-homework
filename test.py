...
class AppDynamicsJob(unittest.TestCase):
    def setUp(self):
        ...
        self.driver = webdriver.Chrome(r'C:\chromedriver\chromedriver.exe')
    ...
    def test_app_dynamics_job(self):
        ...
        driver.find_element_by_xpath(
            ...
            u"Александр")
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Registration'])[2]/following::form[1]").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Email*'])[1]/following::input[1]").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Email*'])[1]/following::input[1]").clear()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Email*'])[1]/following::input[1]").send_keys(
            u"лаовлоал")
        driver.find_element_by_xpath(
